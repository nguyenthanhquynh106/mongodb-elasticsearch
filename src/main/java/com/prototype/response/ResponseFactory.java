...
public class ResponseFactory {
    ...
    public static ResponseEntity<GeneralResponse<Object>> error(HttpStatus httpStatus, ResponseStatusEnum responseStatusEnum) {
        return error(httpStatus, responseStatusEnum, null);
    }

    public static ResponseEntity<GeneralResponse<Object>> error(HttpStatus httpStatus, ResponseStatusEnum responseStatusEnum, Object data) {
        GeneralResponse<Object> responseObject = new GeneralResponse<>();
